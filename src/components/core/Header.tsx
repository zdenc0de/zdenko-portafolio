        ...
        <div className="container mx-auto flex max-w-6xl items-center justify-between rounded-full border border-border bg-background/80 p-2 backdrop-blur-sm">
          ...
          <div className="hidden items-center pr-2 md:flex">
            <Link
              ...
              className="rounded-full border border-secondary px-4 py-2 text-sm font-medium text-secondary transition-colors hover:bg-secondary/10"
            >
              Download CV
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2 md:hidden">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full border border-secondary px-3 py-1.5 text-xs font-medium text-secondary transition-colors hover:bg-secondary/10"
            >
              CV
            </Link>
